...
\centering
\tikzset{
  % seize = striped half-moon, release = solid half-moon (both outlined)
  seizehm/.pic={\fill[pattern=north east lines] (-1.7mm,0) -- (1.7mm,0) arc (0:-180:1.7mm) -- cycle;
                \draw[line width=0.3pt] (-1.7mm,0) -- (1.7mm,0) arc (0:-180:1.7mm) -- cycle;},
  relhm/.pic={\fill[black!40] (-1.7mm,0) -- (1.7mm,0) arc (0:-180:1.7mm) -- cycle;
              \draw[line width=0.3pt] (-1.7mm,0) -- (1.7mm,0) arc (0:-180:1.7mm) -- cycle;}}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}[
  ...
  fl/.style={->, thick},
  sr/.style={densely dotted, gray!60}]
...
\draw[sr] (pnew)--(rbn); \pic at ($(pnew)!0.42!(rbn)$){seizehm}; \pic at ($(pnew)!0.72!(rbn)$){relhm};
\draw[sr] (pold)--(rbo); \pic at ($(pold)!0.42!(rbo)$){seizehm}; \pic at ($(pold)!0.72!(rbo)$){relhm};
\draw[sr] (gran)--(rg);  \pic at ($(gran)!0.42!(rg)$){seizehm};  \pic at ($(gran)!0.74!(rg)$){relhm};
...
\draw[sr] (dry)--(rd);  \pic at ($(dry)!0.42!(rd)$){seizehm};  \pic at ($(dry)!0.74!(rd)$){relhm};
\draw[sr] (comp)--(rp); \pic at ($(comp)!0.42!(rp)$){seizehm}; \pic at ($(comp)!0.74!(rp)$){relhm};
...
\draw[fl] (core.south) -- (10.3,-5.9) -- (0.7,-5.9) -- (0.7,-8.0) -- (coat.west) node[pos=0.05,above,font=\tiny]{no};
...
\draw[sr] (coat)--(rc); \pic at ($(coat)!0.42!(rc)$){seizehm}; \pic at ($(coat)!0.74!(rc)$){relhm};
\draw[sr] (pack)--(rl); \pic at ($(pack)!0.42!(rl)$){seizehm}; \pic at ($(pack)!0.74!(rl)$){relhm};

% ---- Shared cleaning team (one resource, seized at the three cleans) ----
\node[rs, fill=black!16] (clt) at (4.6,-9.7) {Cleaning\\team};
% short vertical links to coating and packaging cleans
\draw[sr] (clt) -- (2.1,-9.7) -- (coat.south);
  \pic at (2.1,-9.0){seizehm}; \pic at (2.1,-8.5){relhm};
\draw[sr] (clt) -- (7.0,-9.7) -- (pack.south);
  \pic at (7.0,-9.0){seizehm}; \pic at (7.0,-8.5){relhm};
% link up the left margin to the drying clean
\draw[sr] (clt) -- (0.3,-9.7) -- (0.3,-5.0) -- (3.9,-5.0) -- (dry.south);
  \pic at (3.0,-9.7){seizehm}; \pic at (2.4,-9.7){relhm};
\end{tikzpicture}%
}
