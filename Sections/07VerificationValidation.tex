...
\begin{itemize}\setlength\itemsep{1pt}
  \item Analytic sanity: drying carries the largest required machine-hours
        ($\approx\SI{300}{h}$ over the plan, Table~\ref{tab:capacity})
        $\Rightarrow$ \textbf{drying} is the expected constraint, ahead of the
        cleaning team and packaging. The simulated baseline utilisation
        (drying \SI{94.9}{\percent}, cleaning team \SI{79.6}{\percent},
        packaging \SI{52.2}{\percent}) confirms this ordering.
...
$\overline{\text{WIP}}=19.53$ batches --- a \SI{0.9}{\percent} discrepancy, well
within sampling error. The three flow KPIs are mutually consistent, confirming
the model conserves work.
