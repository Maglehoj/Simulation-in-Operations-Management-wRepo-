...
ordering: drying \SI{94.9}{\percent}, cleaning team \SI{81.0}{\percent} and
packaging \SI{53.0}{\percent}. The per-station mean processing times also
...
\midrule
Batch conservation   & in $=$ shipped $+$ scrapped $=50$ & $47.5 + 2.5 = 50.0$ & \checkmark \\
Primary constraint   & drying (largest unit-h)           & drying \SI{94.9}{\percent} util & \checkmark \\
Constraint ordering  & drying $>$ clean $>$ packaging     & $94.9 > 81.0 > 53.0$ & \checkmark \\
Little's Law         & $\overline{\text{WIP}} \approx \lambda\overline{W}$ & $19.64$ vs.\ $19.77$ (\SI{0.7}{\percent}) & \checkmark \\
\bottomrule
\end{tabularx}
\end{table}
...
count over the makespan: $\lambda = 47.5/440.6 = 0.1077$ batches/h. With
$\overline{W}=\SI{182.3}{\hour}$ this
predicts $\lambda\overline{W}=19.64$ batches, against a directly measured
$\overline{\text{WIP}}=19.77$ batches, a \SI{0.7}{\percent} discrepancy that is
