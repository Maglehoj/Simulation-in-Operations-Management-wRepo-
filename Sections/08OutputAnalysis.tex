...
\midrule
Mean flow time (h)         & 182.3  & 6.93   & 3.24   & \SI{1.8}{\percent} & 3 \\
Completion / makespan (h)  & 440.6  & 14.33  & 6.71   & \SI{1.5}{\percent} & 2 \\
Throughput (bottles)       & 61{,}761 & 1{,}939 & 907 & \SI{1.5}{\percent} & 2 \\
Avg.\ WIP (batches)        & 19.8   & 0.65   & 0.30   & \SI{1.5}{\percent} & 2 \\
Dryer utilisation          & 0.949  & 0.006  & 0.003  & \SI{0.3}{\percent} & 1 \\
Scrap rate                 & 0.051  & 0.031  & 0.015  & \SI{29}{\percent}  & 5\textsuperscript{*} \\
\bottomrule
\end{tabularx}
\end{table}
