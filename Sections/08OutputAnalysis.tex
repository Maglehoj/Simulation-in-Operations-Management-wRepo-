...
of any single added machine falls below the detectable threshold. As shown in
Section~\ref{sec:experiments}, that non-detectability is itself a result: it confirms
the line is demand limited rather than capacity limited, so adding one unit of
capacity does not move the operational KPIs by a statistically meaningful amount.
