...
\textcolor{orange!80!black}{\textbf{M:}} \texttt{onTimePct} and \texttt{maxTardiness}: completion vs.\ due date (planned $+$ \SI{332}{h} lead $+$ \SI{24}{h} grace; the \SI{332}{h} lead is the baseline maximum flow time, so baseline is on time by construction and any lateness reflects volume growth). \newline
